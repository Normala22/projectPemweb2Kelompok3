...
<body id="body-pd">
        ...
        <nav class="nav">
            <div> 
                ...
                <div class="nav_list"> 
                    ...
                    <a href="{{ route('peminjaman.index') }}" class="nav_link active"> <i class='bx bx-message-square-detail nav_icon'></i> <span class="nav_name">Peminjaman</span> </a> 
    ...
    <div class="container mt-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <!-- Form pencarian -->
            <form action="{{ route('peminjaman.index') }}" method="GET" class="topnav d-flex">
